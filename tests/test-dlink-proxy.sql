...
BEGIN
    ...
    INSERT INTO device(name, description, type_id, ip_address, status_history_size, sampling_rate, default_sampling_rate, data_node_id) VALUES ('CAM1', 'Test cam', dtype.id, '10.27.151.114', 1, 10000, 10000, dnodeid.id) RETURNING id INTO d;
